...
if (empty($cliente) || empty($data) || empty($horario) || empty($servico)) {
    ...
    <style>
        ...
        .btn { display:inline-block; margin:12px 6px 0 6px; padding:8px 14px; background:#721c24; color:#fff; text-decoration:none; border-radius:6px; }
    </style></head><body>
    <div class='mensagem'>Preencha todos os campos obrigatórios.<br>
...
if ($stmt2->execute()) {
    ...
    <style>
        ...
        .btn { display: inline-block; margin: 12px 6px 0 6px; padding: 10px 20px; background: #4CAF50; 
    ...
    <div class='mensagem'>
        ...
        <a href='listar.php' class='btn'>Ver agendamentos</a>
    </div>
    </body></html>";
} 
// Mensagem de erro
    ...
    <style>
        ...
        .btn { display:inline-block; margin:12px 6px 0 6px; padding:8px 14px; background:#721c24; 
